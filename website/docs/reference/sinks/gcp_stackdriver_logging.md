...
[sinks.my_sink_id]
  ...
  # OPTIONAL - General
  billing_account_id = "vector-123456" # example, no default
  folder_id = "vector-123456" # example, no default
  healthcheck = true # default
  log_id = "vector-123456" # example, no default
  organization_id = "vector-123456" # example, no default
...
Exactly one of [`billing_account_id`](#billing_account_id), [`folder_id`](#folder_id), [`log_id`](#log_id), or [`organization_id`](#organization_id) must be set.
